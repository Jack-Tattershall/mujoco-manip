...
from mujoco_manip.data import SCENE_XML as _DEFAULT_XML
...
class PickPlaceGymEnv(gym.Env):
    ...
    def _get_obs(self) -> dict[str, np.ndarray]:
        ...
        kp_overhead = compute_keypoints(
            model, data, "overhead", KEYPOINT_BODIES, self._image_size
        )
        kp_wrist = compute_keypoints(
            model, data, "wrist", KEYPOINT_BODIES, self._image_size
        )
